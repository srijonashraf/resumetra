...
export async function up(pgm) {
  ...
  pgm.createTable(
    "resume_metrics",
    {
      ...
      ats_issues: { type: "text[]", notNull: true, default: "'{}'" },
      created_at: { type: "timestamptz", notNull: true, default: pgm.func("timezone('utc'::text, now())") },
      updated_at: { type: "timestamptz", notNull: true, default: pgm.func("timezone('utc'::text, now())") },
    },
    { ifNotExists: true }
  ...
  pgm.createTable(
    "resume_parsed_data",
    {
      ...
      technical_skills: { type: "text[]", notNull: true, default: "'{}'" },
      soft_skills: { type: "text[]", notNull: true, default: "'{}'" },
      job_titles: { type: "text[]", notNull: true, default: "'{}'" },
      education: { type: "jsonb", notNull: true, default: "'[]'::jsonb" },
      work_experiences: { type: "jsonb", notNull: true, default: "'[]'::jsonb" },
      projects: { type: "jsonb", notNull: true, default: "'[]'::jsonb" },
      certifications: { type: "jsonb", notNull: true, default: "'[]'::jsonb" },
      created_at: { type: "timestamptz", notNull: true, default: pgm.func("timezone('utc'::text, now())") },
      updated_at: { type: "timestamptz", notNull: true, default: pgm.func("timezone('utc'::text, now())") },
    },
    { ifNotExists: true }
  ...
  pgm.createTable(
    "resume_feedback",
    {
      ...
      weaknesses: { type: "text[]", notNull: true, default: "'{}'" },
      improvement_areas: { type: "text[]", notNull: true, default: "'{}'" },
      missing_skills: { type: "text[]", notNull: true, default: "'{}'" },
      red_flags: { type: "text[]", notNull: true, default: "'{}'" },
      suggestions_immediate: { type: "text[]", notNull: true, default: "'{}'" },
      suggestions_short_term: { type: "text[]", notNull: true, default: "'{}'" },
      suggestions_long_term: { type: "text[]", notNull: true, default: "'{}'" },
      created_at: { type: "timestamptz", notNull: true, default: pgm.func("timezone('utc'::text, now())") },
    },
    { ifNotExists: true }
  );
